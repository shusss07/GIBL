...
# ---------------------------------------------------------------------------
# Data directory — override with DATA_DIR env var, defaults to data/ in project root
# ---------------------------------------------------------------------------
...
NETFLOW_CSV = os.path.join(DATA_DIR, "netflow_records.csv")
TRAIN_LABELS_CSV = os.path.join(DATA_DIR, "ids_labels_train.csv")
HOSTS_CSV = os.path.join(DATA_DIR, "host_profiles.csv")
WINDOWS_LOG = os.path.join(DATA_DIR, "windows_event_logs.csv")
ZEEK_LOG = os.path.join(DATA_DIR, "zeek_conn_logs.csv")
UEBA_CSV = os.path.join(DATA_DIR, "ueba_user_behavior.csv")
TICKETS_CSV = os.path.join(DATA_DIR, "incident_tickets.csv")
OUTPUT_DIR = "outputs"
