...
# Enrichment data
NETFLOW_PATH_DEFAULT = os.path.join(DATA_DIR, "netflow_records.csv")
HOST_PROFILES_PATH_DEFAULT = os.path.join(DATA_DIR, "host_profiles.csv")
LABELS_PATH_DEFAULT = os.path.join(DATA_DIR, "ids_labels_train.csv")
INCIDENT_TICKETS_PATH_DEFAULT = os.path.join(DATA_DIR, "incident_tickets.csv")
...
if __name__ == "__main__":
    ...
    out_path_final = os.path.join(OUTPUT_DIR, "submission_JIJIBISHA_GIBL.csv")
